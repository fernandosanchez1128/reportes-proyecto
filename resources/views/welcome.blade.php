...
@section ('content')
    ...
    <h1 class="page-header">Nivel de ventas por a�o</h1>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h2 class="panel-title">
    ...
    <div class="panel panel-default">
        ...
        <div id="ventas_producto_tiempo_internet" class = "collapse">
                                            ...
                                            <!-- CLIENTES VENTAS POR A�O -->
            <div class="panel-heading">
                <h2 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#internet_ano">Ventas por producto(subcategoria) en el a�o</a>
                </h2>
            </div>
        ...
        <div id="ventas_producto_tiempo_vendedores" class = "collapse">
            ...
            <!-- vendedoresS VENTAS POR A�O -->
            <div class="panel-heading">
                <h2 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#vendedores_ano">Ventas por producto(subcategoria) en el a�o</a>
                </h2>
            </div>
