...
@section ('content')
    ...
    {{--<select id="id_ajax" name="ajax" >--}}
        ...
        <div class="panel panel-default">
            ...
            <div id="value" class = "collapse">
                Desde
                <input type="date" class = "date" name="inicio" id="inicio" value = "2010-01-29" >

                hasta
                <input type="date" class = "date" name="fin" id="fin" value = "2014-01-28">
        ...
        <div class="panel panel-default">
            ...
            <div id="value2" class = "collapse">
                Desde
                <input type="date" class = "date" name="inicio_resell" id="inicio_resell" value = "2010-01-29" >

                hasta
                <input type="date" class = "date" name="fin_resell" id="fin_resell" value = "2014-01-28">
        ...
        <div class="panel panel-default">
            ...
            <div id="monedas_vendedores" class = "collapse">
                Desde
                <input type="date" class = "date" name="inicio_mone2" id="inicio_mone2" value = "29-10-2010" >

                hasta
                <input type="date" class = "date" name="fin_mone2" id="fin_mone2" value = "28-01-2014">
    ...
    <div class="panel panel-default">
        ...
        <div id="comparativo_ventas" class = "collapse">
            Desde
            <input type="date" class = "date_month" name="inicio_comp" id="inicio_comp"  >

            hasta
            <input type="date" class = "date_month" name="fin_comp" id="fin_comp" >
