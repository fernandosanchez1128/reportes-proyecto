...
$(document).ready(function () {
    $('#graph_categories').click(function () {
        $.get("ventas_productos_categorias_internet",
            {inicio: $(inicio).val(),fin: $(fin).val()}, //datos enviados
            function (data) {          //datos recibidos
                $("#chart_prod_internet").empty();
                ...
                var chart = AmCharts.makeChart("chart_prod_internet", {
            ...
            .fail(function() {
                $("#chart_prod_internet").empty();
                $("#chart_prod_internet").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});