...
$(document).ready(function () {
    $('#graph_categories2').click(function () {
        $.get("ventas_productos_categorias_reseller",
            {inicio: $(inicio_resell).val(),fin: $(fin_resell).val()}, //datos enviados
            function (data) {          //datos recibidos
                $("#chart_prod_reseller").empty();
                ...
                var chart = AmCharts.makeChart("chart_prod_reseller", {
                    ...
                    "categoryField": "SpanishProductCategoryName",
                    "categoryAxis": {
                        "gridPosition": "start",
                        "axisAlpha":0,
                        "gridAlpha":0
            ...
            .fail(function() {
                $("#chart_prod_reseller").empty();
                $("#chart_prod_reseller").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});