...
$(document).ready(function () {
    $('#graph_pais').click(function () {
        $.get("paises_online",
            {inicio: $(inicio_pais).val(),fin: $(fin_pais).val()}, //datos enviados
            function (data) {          //datos recibidos
                ...
                var chart = AmCharts.makeChart("chartpais", {
            ...
            .fail(function() {
                $("#chartpais").empty();
                $("#chartpais").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});