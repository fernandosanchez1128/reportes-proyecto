...
$(document).ready(function () {
    $('#graph_pdpto').click(function () {
        $.get("presupuesto_dpto",
            {inicio: $(inicio_pdpto).val(),fin: $(fin_pdpto).val()}, //datos enviados
            function (data) {          //datos recibidos
                ...
                var chart = AmCharts.makeChart("chartpdpto", {
                    ...
                    "categoryField": "DepartmentGroupName",
                    "categoryAxis": {
                        "gridPosition": "start",
                        "axisAlpha":0,
                        "gridAlpha":0
            ...
            .fail(function() {
                $("#chartpdpto").empty();
                $("#chartpdpto").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});
