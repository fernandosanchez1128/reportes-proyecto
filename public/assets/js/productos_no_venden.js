...
$(document).ready(function () {
    $('#graph_pnv').click(function () {
        $.get("productos_no_venden",
            {inicio: $(inicio_pnv).val(),fin: $(fin_pnv).val()}, //datos enviados
            function (data) {          //datos recibidos
                ...
                var chart = AmCharts.makeChart("chartpnv", {
                    ...
                    "categoryField": "SpanishProductName",
                    "categoryAxis": {
                        "gridPosition": "start",
                        "axisAlpha":0,
                        "gridAlpha":0
            ...
            .fail(function() {
                $("#chartpnv").empty();
                $("#chartpnv").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});
