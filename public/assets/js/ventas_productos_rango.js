...
$(document).ready(function () {
    $('#bt_ventas_producto_rango_internet').click(function () {
        var inicio=$(ventas_producto_rango_inicio_internet).val();
        var fin=$(ventas_producto_rango_fin_internet).val();
        console.log(inicio,fin)
        $.get("ventas_internet_por_producto_agrupado_rango",
            ...
            function (data) {
                ...
                console.log(data);
                var chart = AmCharts.makeChart("chart_ventas_producto_rango_internet", {
                    "theme": "light",
                    "type": "serial",
                    "startDuration": 2,
                    "dataProvider": data,
...
$(document).ready(function () {
    ...
    $('#bt_ventas_producto_rango_vendedores').click(function () {
        var inicio=$(ventas_producto_rango2_inicio_vendedores).val()
        var fin=$(ventas_producto_rango2_fin_vendedores).val()
        $.get("ventas_vendedores_por_producto_agrupado_rango",
            ...
            function (data) {
                ...
                console.log(data);
                console.log([value]);
                var chart = AmCharts.makeChart("chart_ventas_producto_rango_vendedores", {
                    "theme": "light",
                    "type": "serial",
                    "startDuration": 2,
                    "dataProvider": data,
