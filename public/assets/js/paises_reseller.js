...
$(document).ready(function () {
    $('#graph_pais2').click(function () {
        $.get("paises_reseller",
            {inicio: $(inicio_pais2).val(),fin: $(fin_pais2).val()}, //datos enviados
            function (data) {          //datos recibidos
                ...
                var chart = AmCharts.makeChart("chartpais2", {
                    ...
                    "categoryField": "SalesTerritoryCountry",
                    "categoryAxis": {
                        "gridPosition": "start",
                        "axisAlpha":0,
                        "gridAlpha":0
            ...
            .fail(function() {
                $("#chartpais2").empty();
                $("#chartpais2").html(" <br> <br> <br> <br> <br>   <p align= 'center'>  error cargando el grafico</p>");
            })
    });
});